...
public class InputHelpers 
{
	...
	public static boolean fieldNotEmpty(JTextField theField, String info)
	{
		...
		{
			notEmpty = false;
			OutputHelpers.showExceptionDialog(info + " cannot be empty!", "Empty " + info + " input");
	...
	public static double parseDoubleField(JTextField theField, String info)
	{
		...
		{
			OutputHelpers.showExceptionDialog(ex.getMessage() + ": info", info + " input");
			value = CANCEL_FLAG;
		}
		return value;
	}
	public static double parseDoubleField(JTextField theField, String info, double minValue, double maxValue)
	{
		...
		try
		{
			if (fieldNotEmpty(theField, info))
			{
				...
				{
					OutputHelpers.showExceptionDialog(info + " needs to be a real number between " + minValue + " and " + maxValue, info + " input");
					value = CANCEL_FLAG;
					theField.setText("");
					theField.requestFocus();
				}
